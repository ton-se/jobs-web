...
export async function proxy(req: NextRequest) {
    ...
    const isBot = /(facebookexternalhit|Twitterbot|Pinterest|Slackbot|WhatsApp|LinkedInBot|Discordbot|TelegramBot|Googlebot|bingbot|DuckDuckBot|YandexBot|vercelBot|Screaming\s*Frog|facebookcatalog|Applebot|Embedly|Quora\s*Link\s*Preview|ia_archiver)/i.test(ua)
